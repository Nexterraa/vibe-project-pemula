...
<div class="container py-5 text-center">
  <div class="bg-white rounded-4 shadow-sm p-5 mx-auto" style="max-width:580px;">
    ...
    <div
      class="bg-success-subtle text-success rounded-circle d-inline-flex align-items-center justify-content-center mb-4"
      style="width:80px;height:80px;font-size:2.5rem;">
      <i class="fas fa-check"></i>
    </div>
    <h2 class="fw-800 text-success mb-2">Pesanan Berhasil!</h2>
    <p class="text-muted mb-4">Terima kasih telah berbelanja di <strong>Toko Sayur Online</strong>. Pesanan Anda sedang
      diproses.</p>
    ...
    <?php if ($order['payment_method'] === 'transfer'): ?>
      <div class="alert alert-info text-start mb-4">
        ...
        Silakan transfer ke <strong>BCA 1234567890 a.n. Toko Sayur Online</strong> sebesar
        <strong><?= rupiah($order['grand_total']) ?></strong> dan konfirmasi via WhatsApp ke
