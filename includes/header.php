...
<head>
  ...
  <meta name="description"
    content="Toko Sayur Online - Belanja sayur segar berkualitas, dikirim langsung ke rumah Anda.">
    ...
    <div class="container">
      ...
      <div class="d-flex align-items-center gap-2 d-lg-none">
        <a href="<?= BASE_URL ?>/cart.php" class="btn btn-cart-mobile position-relative">
          ...
          <span class="cart-badge-mobile" id="cartBadgeMobile" style="<?= $cartCount > 0 ? '' : 'display:none;' ?>"><?= $cartCount ?></span>
        </a>
      ...
      <div class="collapse navbar-collapse" id="navMenu">
        ...
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-1">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle <?= $currentPage === 'products.php' ? 'active' : '' ?>"
              href="<?= BASE_URL ?>/products.php" role="button" data-bs-toggle="dropdown">
              <i class="fas fa-store me-1"></i>Produk
            </a>
            <ul class="dropdown-menu dropdown-menu-custom">
              <li><a class="dropdown-item" href="<?= BASE_URL ?>/products.php"><i
                    class="fas fa-th me-2 text-success"></i>Semua Produk</a></li>
              <li>
          ...
          <?php if (isLoggedIn()): ?>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                <li>
                  <h6 class="dropdown-header"><?= e($_SESSION['user_name']) ?></h6>
                </li>
                ...
                <li><a class="dropdown-item" href="<?= BASE_URL ?>/my_orders.php"><i
                      class="fas fa-receipt me-2 text-success"></i>Pesanan Saya</a></li>
                <?php if (isAdmin()): ?>
                  <li><a class="dropdown-item" href="<?= BASE_URL ?>/admin/index.php"><i
                        class="fas fa-gauge me-2 text-success"></i>Dashboard Admin</a></li>
                  <li>
                    <hr class="dropdown-divider">
                  </li>
                <?php endif; ?>
                <li><a class="dropdown-item" href="<?= BASE_URL ?>/auth/logout.php"><i
                      class="fas fa-sign-out-alt me-2 text-danger"></i>Keluar</a></li>
              </ul>
            </div>
          <?php else: ?>
