...
<div class="container py-4">
  ...
  <h2 class="fw-800 mb-4"><i class="fas fa-shopping-basket me-2 text-success"></i>Keranjang Belanja
  ...
  <div class="row g-4">
              ...
              <tr id="cart-row-<?= $pid ?>">
                ...
                <td class="text-center align-middle">
                  <div class="d-flex align-items-center justify-content-center gap-1">
                    <button class="qty-btn cart-qty-minus" data-pid="<?= $pid ?>" style="width:28px;height:28px;font-size:.9rem;">−</button>
                    <input type="number" class="qty-input cart-qty-input" value="<?= $item['qty'] ?>" min="1" max="<?= $item['stock'] ?>" data-pid="<?= $pid ?>">
                    <button class="qty-btn cart-qty-plus" data-pid="<?= $pid ?>" style="width:28px;height:28px;font-size:.9rem;">+</button>
                  </div>
                </td>
                <td class="text-center align-middle fw-700 text-success" id="subtotal-<?= $pid ?>"><?= rupiah($item['price'] * $item['qty']) ?></td>
                <td class="text-center align-middle">
                  <button class="btn btn-sm btn-outline-danger rounded-3 cart-remove" data-pid="<?= $pid ?>" title="Hapus">
    ...
    <div class="col-lg-4">
      <div class="cart-summary">
        ...
        <a href="<?= BASE_URL ?>/checkout.php" class="btn btn-success-custom w-100 py-3 mt-3 fw-700 rounded-3">
