...
$stmt = $pdo->prepare("SELECT p.*, c.name as cat_name FROM products p LEFT JOIN categories c ON p.category_id = c.id WHERE $whereClause ORDER BY p.id DESC");
$stmt->execute($params);
  ...
  <div class="table-responsive">
    <table class="table admin-table mb-0">
      ...
      <tbody>
        ...
        <tr><td colspan="7" class="text-center py-5 text-muted"><i class="fas fa-box-open fs-3 d-block mb-2"></i>Belum ada produk.</td></tr>
        <?php else: ?>
